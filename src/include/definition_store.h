...
struct Region {
  ...
  bool operator==(const Region& rhs) {
    return (rhs.s_name == this->s_name && rhs.s_description == this->s_description &&
...
struct ParadigmProperty {
  ...
  bool operator==(const ParadigmProperty& rhs) {
    return (rhs.s_paradigm == this->s_paradigm && rhs.s_property == this->s_property &&
            rhs.s_type == this->s_type);
  }
};
...
struct IoParadigm {
  ...
  bool operator==(const IoParadigm& rhs) {
    return (rhs.s_identification == this->s_identification && rhs.s_name == this->s_name &&
            rhs.s_ioParadigmClass == this->s_ioParadigmClass &&
            rhs.s_ioParadigmFlags == this->s_ioParadigmFlags &&
            rhs.s_ioProperties == this->s_ioProperties && rhs.s_types == this->s_types);
  }
};
...
struct SystemTreeNode {
  ...
  bool operator==(const SystemTreeNode& rhs) {
    return (rhs.s_name == this->s_name && rhs.s_className == this->s_className &&
...
struct SystemTreeNodeProperty {
  ...
  bool operator==(const SystemTreeNodeProperty& rhs) {
    return (rhs.s_systemTreeNode == this->s_systemTreeNode && rhs.s_name == this->s_name &&
            rhs.s_type == this->s_type && rhs.s_value.uint32 == this->s_value.uint32);
  }
};
...
struct Group {
  ...
  bool operator==(const Group& rhs) {
    return (rhs.s_name == this->s_name && rhs.s_groupType == this->s_groupType &&
...
struct Parameter {
  ...
  bool operator==(const Parameter& rhs) {
    return (rhs.s_name == this->s_name && rhs.s_parameterType == this->s_parameterType);
  }
};
...
struct IoFileDefinition {
  ...
  bool operator==(const IoFileDefinition& rhs) const {
    return std::tie(this->s_name, this->s_scope, this->s_ioType, this->s_ioProperty) ==
...
struct IoHandle {
  ...
  bool operator==(const IoHandle& rhs) {
    return (rhs.s_name == this->s_name && rhs.s_file == this->s_file &&
            ...
            rhs.s_IoHandleFlags == this->s_IoHandleFlags && rhs.s_comm == this->s_comm &&
            rhs.s_parent == this->s_parent);
  }
};
...
public:
  ...
  std::tuple<vector<string>::iterator, vector<string>::iterator> getStringRange();

  size_t insertDefinition(const Region& region);
  std::tuple<vector<Region>::iterator, vector<Region>::iterator> getRegionRange();

  void insertDefinition(const Paradigm& paradigm);
  std::tuple<vector<Paradigm>::iterator, vector<Paradigm>::iterator> getParadigmRange();
  ...
  std::tuple<vector<IoParadigm>::iterator, vector<IoParadigm>::iterator> getIoParadigmRange();

  bool   hasAbstractNode();
  size_t insertDefinition(SystemTreeNode& sysTreeNode);
  size_t verifyAbstractParent(const size_t sysNodeName);
  ...
  std::tuple<vector<Location>::iterator, vector<Location>::iterator> getLocationRange();
  ...
  std::tuple<vector<Parameter>::iterator, vector<Parameter>::iterator> getParameterRange();

  void insertDefinition(const Attribute& attributes);
  std::tuple<vector<Attribute>::iterator, vector<Attribute>::iterator> getAttributeRange();
  ...
  std::tuple<vector<IoHandle>::iterator, vector<IoHandle>::iterator> getIoHandleRange();
