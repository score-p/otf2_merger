...
GlobalEvtReaderCallback_MpiSend([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleMPISend(attributeList, time, receiver, communicator, msgTag, msgLength);
...
GlobalEvtReaderCallback_MpiRecv([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleMPIRecv(attributeList, time, sender, communicator, msgTag, msgLength);
...
GlobalEvtReaderCallback_MpiIsend([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleMPIISend(attributeList, time, receiver, communicator, msgTag, msgLength,
                         requestID);
...
GlobalEvtReaderCallback_MpiIrecv([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleMPIIRecv(attributeList, time, sender, communicator, msgTag, msgLength,
                         requestID);
...
GlobalEvtReaderCallback_MpiIsendComplete([[maybe_unused]] OTF2_LocationRef locationID,
                                         OTF2_TimeStamp time, void* userData,
...
GlobalEvtReaderCallback_MpiIrecvRequest([[maybe_unused]] OTF2_LocationRef locationID,
                                        OTF2_TimeStamp time, void* userData,
                                        OTF2_AttributeList* attributeList,
                                        uint64_t            requestID) {
  EventProcessor* reader{static_cast<EventProcessor*>(userData)};
...
GlobalEvtReaderCallback_MpiRequestTest([[maybe_unused]] OTF2_LocationRef locationID,
                                       OTF2_TimeStamp time, void* userData,
...
GlobalEvtReaderCallback_MpiRequestCancelled([[maybe_unused]] OTF2_LocationRef locationID,
                                            OTF2_TimeStamp time, void* userData,
                                            OTF2_AttributeList* attributeList,
                                            uint64_t            requestID) {
  EventProcessor* reader{static_cast<EventProcessor*>(userData)};
...
GlobalEvtReaderCallback_MpiCollectiveBegin([[maybe_unused]] OTF2_LocationRef locationID,
                                           OTF2_TimeStamp time, void* userData,
                                           OTF2_AttributeList* attributeList) {
  EventProcessor* reader{static_cast<EventProcessor*>(userData)};
...
GlobalEvtReaderCallback_MpiCollectiveEnd([[maybe_unused]] OTF2_LocationRef locationID,
                                         OTF2_TimeStamp time, void* userData,
                                         OTF2_AttributeList* attributeList,
  ...
  reader->handleMPIEndProps(attributeList, time, collectiveOp, communicator, root, sizeSent,
                            sizeReceived);
...
GlobalEvtReaderCallback_OmpAcquireLock([[maybe_unused]] OTF2_LocationRef locationID,
                                       OTF2_TimeStamp time, void* userData,
                                       OTF2_AttributeList* attributeList, uint32_t lockID,
...
GlobalEvtReaderCallback_OmpReleaseLock([[maybe_unused]] OTF2_LocationRef locationID,
                                       OTF2_TimeStamp time, void* userData,
                                       OTF2_AttributeList* attributeList, uint32_t lockID,
                                       uint32_t acquisitionOrder) {
...
GlobalEvtReaderCallback_OmpTaskCreate([[maybe_unused]] OTF2_LocationRef locationID,
                                      OTF2_TimeStamp time, void* userData,
                                      OTF2_AttributeList* attributeList, uint64_t taskID) {
...
GlobalEvtReaderCallback_OmpTaskSwitch([[maybe_unused]] OTF2_LocationRef locationID,
                                      OTF2_TimeStamp time, void* userData,
                                      OTF2_AttributeList* attributeList, uint64_t taskID) {
...
GlobalEvtReaderCallback_OmpTaskComplete([[maybe_unused]] OTF2_LocationRef locationID,
                                        OTF2_TimeStamp time, void* userData,
                                        OTF2_AttributeList* attributeList, uint64_t taskID) {
...
GlobalEvtReaderCallback_ThreadFork([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleThreadFork(attributeList, time, model, numberOfRequestedThreads);
...
GlobalEvtReaderCallback_ThreadTeamBegin([[maybe_unused]] OTF2_LocationRef locationID,
                                        OTF2_TimeStamp time, void* userData,
                                        OTF2_AttributeList* attributeList,
...
GlobalEvtReaderCallback_ThreadTeamEnd([[maybe_unused]] OTF2_LocationRef locationID,
                                      OTF2_TimeStamp time, void* userData,
                                      OTF2_AttributeList* attributeList,
                                      OTF2_CommRef        threadTeam) {
...
GlobalEvtReaderCallback_ThreadAcquireLock([[maybe_unused]] OTF2_LocationRef locationID,
                                          OTF2_TimeStamp time, void* userData,
                                          OTF2_AttributeList* attributeList,
  ...
  reader->handleThreadAcquireLock(attributeList, time, model, lockID, acquisitionOrder);
...
GlobalEvtReaderCallback_ThreadReleaseLock([[maybe_unused]] OTF2_LocationRef locationID,
                                          OTF2_TimeStamp time, void* userData,
                                          OTF2_AttributeList* attributeList,
                                          OTF2_Paradigm model, uint32_t lockID,
                                          uint32_t acquisitionOrder) {
  ...
  reader->handleThreadReleaseLock(attributeList, time, model, lockID, acquisitionOrder);
...
GlobalEvtReaderCallback_ThreadTaskCreate([[maybe_unused]] OTF2_LocationRef locationID,
                                         OTF2_TimeStamp time, void* userData,
                                         OTF2_AttributeList* attributeList,
  ...
  reader->handleThreadTaskCreate(attributeList, time, threadTeam, creatingThread,
                                 generationNumber);
...
GlobalEvtReaderCallback_ThreadTaskSwitch([[maybe_unused]] OTF2_LocationRef locationID,
                                         OTF2_TimeStamp time, void* userData,
                                         OTF2_AttributeList* attributeList,
                                         OTF2_CommRef threadTeam, uint32_t creatingThread,
                                         uint32_t generationNumber) {
...
GlobalEvtReaderCallback_ThreadTaskComplete([[maybe_unused]] OTF2_LocationRef locationID,
                                           OTF2_TimeStamp time, void* userData,
                                           OTF2_AttributeList* attributeList,
                                           OTF2_CommRef threadTeam, uint32_t creatingThread,
                                           uint32_t generationNumber) {
  ...
  reader->handleThreadTaskComplete(attributeList, time, threadTeam, creatingThread,
                                   generationNumber);
...
GlobalEvtReaderCallback_ThreadCreate([[maybe_unused]] OTF2_LocationRef locationID,
                                     OTF2_TimeStamp time, void* userData,
                                     OTF2_AttributeList* attributeList,
  ...
  reader->handleThreadCreate(attributeList, time, threadContingent, sequenceCount);
...
GlobalEvtReaderCallback_ThreadBegin([[maybe_unused]] OTF2_LocationRef locationID,
                                    OTF2_TimeStamp time, void* userData,
                                    OTF2_AttributeList* attributeList,
                                    OTF2_CommRef threadContingent, uint64_t sequenceCount) {

  EventProcessor* reader{static_cast<EventProcessor*>(userData)};
  reader->handleThreadBegin(attributeList, time, threadContingent, sequenceCount);
  return OTF2_CALLBACK_SUCCESS;
}
...
GlobalEvtReaderCallback_ThreadWait([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleThreadWait(attributeList, time, threadContingent, sequenceCount);
...
GlobalEvtReaderCallback_IoCreateHandle([[maybe_unused]] OTF2_LocationRef locationID,
                                       OTF2_TimeStamp time, void* userData,
                                       OTF2_AttributeList* attributeList,
  ...
  reader->handleIoCreateHandle(attributeList, time, handle, mode, creationFlags, statusFlags);
...
GlobalEvtReaderCallback_IoDestroyHandle([[maybe_unused]] OTF2_LocationRef locationID,
                                        OTF2_TimeStamp time, void* userData,
                                        OTF2_AttributeList* attributeList,
...
GlobalEvtReaderCallback_IoDuplicateHandle([[maybe_unused]] OTF2_LocationRef locationID,
                                          OTF2_TimeStamp time, void* userData,
                                          OTF2_AttributeList* attributeList,
  ...
  reader->handleIoHandleDuplicate(attributeList, time, oldHandle, newHandle, statusFlags);
...
GlobalEvtReaderCallback_IoSeek([[maybe_unused]] OTF2_LocationRef locationID,
  ...
  reader->handleIoSeek(attributeList, time, handle, offsetRequest, whence, offsetResult);
...
GlobalEvtReaderCallback_IoChangeStatusFlags([[maybe_unused]] OTF2_LocationRef locationID,
                                            OTF2_TimeStamp time, void* userData,
                                            OTF2_AttributeList* attributeList,
                                            OTF2_IoHandleRef    handle,
                                            OTF2_IoStatusFlag   statusFlags) {
...
GlobalEvtReaderCallback_IoDeleteFile([[maybe_unused]] OTF2_LocationRef locationID,
                                     OTF2_TimeStamp time, void* userData,
                                     OTF2_AttributeList* attributeList,
...
GlobalEvtReaderCallback_IoOperationBegin([[maybe_unused]] OTF2_LocationRef locationID,
                                         OTF2_TimeStamp time, void* userData,
                                         OTF2_AttributeList* attributeList,
  ...
  reader->handleIoOperationBegin(attributeList, time, handle, mode, operationFlags,
...
GlobalEvtReaderCallback_IoOperationTest([[maybe_unused]] OTF2_LocationRef locationID,
                                        OTF2_TimeStamp time, void* userData,
                                        OTF2_AttributeList* attributeList,
...
GlobalEvtReaderCallback_IoOperationIssued([[maybe_unused]] OTF2_LocationRef locationID,
                                          OTF2_TimeStamp time, void* userData,
                                          OTF2_AttributeList* attributeList,
                                          OTF2_IoHandleRef handle, uint64_t matchingId) {
...
GlobalEvtReaderCallback_IoOperationComplete([[maybe_unused]] OTF2_LocationRef locationID,
                                            OTF2_TimeStamp time, void* userData,
                                            OTF2_AttributeList* attributeList,
  ...
  reader->handleIoOperationComplete(attributeList, time, handle, bytesResult, matchingId);
...
GlobalEvtReaderCallback_IoOperationCancelled([[maybe_unused]] OTF2_LocationRef locationID,
                                             OTF2_TimeStamp time, void* userData,
                                             OTF2_AttributeList* attributeList,
                                             OTF2_IoHandleRef handle, uint64_t matchingId) {
...
GlobalEvtReaderCallback_IoAcquireLock([[maybe_unused]] OTF2_LocationRef locationID,
                                      OTF2_TimeStamp time, void* userData,
                                      OTF2_AttributeList* attributeList,
...
GlobalEvtReaderCallback_IoReleaseLock([[maybe_unused]] OTF2_LocationRef locationID,
                                      OTF2_TimeStamp time, void* userData,
                                      OTF2_AttributeList* attributeList,
                                      OTF2_IoHandleRef handle, OTF2_LockType lockType) {
...
EventProcessor::EventProcessor(Maps& maps, OTF2_Reader* reader, OTF2_Archive* archive,
                               const string& traceName)
    : m_maps{maps}, m_otf2Reader{reader}, m_archive{archive}, m_traceName{traceName} {
...
void EventProcessor::readLocationWise() {
  ...
  OTF2_GlobalEvtReaderCallbacks_SetOmpForkCallback(global_evt_callbacks,
                                                   &GlobalEvtReaderCallback_OmpFork);

  OTF2_GlobalEvtReaderCallbacks_SetOmpJoinCallback(global_evt_callbacks,
                                                   &GlobalEvtReaderCallback_OmpJoin);
  ...
  OTF2_GlobalEvtReaderCallbacks_SetThreadForkCallback(global_evt_callbacks,
                                                      &GlobalEvtReaderCallback_ThreadFork);

  OTF2_GlobalEvtReaderCallbacks_SetThreadJoinCallback(global_evt_callbacks,
                                                      &GlobalEvtReaderCallback_ThreadJoin);
  ...
  OTF2_GlobalEvtReaderCallbacks_SetThreadCreateCallback(global_evt_callbacks,
                                                        &GlobalEvtReaderCallback_ThreadCreate);

  OTF2_GlobalEvtReaderCallbacks_SetThreadBeginCallback(global_evt_callbacks,
                                                       &GlobalEvtReaderCallback_ThreadBegin);

  OTF2_GlobalEvtReaderCallbacks_SetThreadWaitCallback(global_evt_callbacks,
                                                      &GlobalEvtReaderCallback_ThreadWait);

  OTF2_GlobalEvtReaderCallbacks_SetThreadEndCallback(global_evt_callbacks,
                                                     &GlobalEvtReaderCallback_ThreadEnd);
  ...
  OTF2_GlobalEvtReaderCallbacks_SetIoSeekCallback(global_evt_callbacks,
                                                  &GlobalEvtReaderCallback_IoSeek);
  ...
  OTF2_GlobalEvtReaderCallbacks_SetIoDeleteFileCallback(global_evt_callbacks,
  ...
  OTF2_GlobalEvtReaderCallbacks_SetIoTryLockCallback(global_evt_callbacks,
                                                     &GlobalEvtReaderCallback_IoTryLock);
  ...
  for (auto location_itr = start_itr; location_itr != end_itr; location_itr++) {
    ...
    bool successful_open_def_files = OTF2_Reader_OpenDefFiles(m_otf2Reader) == OTF2_SUCCESS;
    OTF2_Reader_OpenEvtFiles(m_otf2Reader);

    if (successful_open_def_files) {
      OTF2_DefReader* def_reader = OTF2_Reader_GetDefReader(m_otf2Reader, reading_location);
      if (def_reader) {
        uint64_t def_reads = 0;
        OTF2_Reader_ReadAllLocalDefinitions(m_otf2Reader, def_reader, &def_reads);
    ...
    OTF2_GlobalEvtReader* global_evt_reader = OTF2_Reader_GetGlobalEvtReader(m_otf2Reader);
    ...
    OTF2_Reader_ReadAllGlobalEvents(m_otf2Reader, global_evt_reader, &events_read);
...
void EventProcessor::handleEvtEnter(OTF2_TimeStamp                       time,
...
void EventProcessor::handleEvtLeave(OTF2_TimeStamp                       time,
                                    [[maybe_unused]] OTF2_AttributeList* attributeList,
                                    OTF2_RegionRef                       region) {
...
void EventProcessor::handleMPISend(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
  ...
  OTF2_EvtWriter_MpiSend(m_evtWriter, attributeList, time, receiver, communicator, msgTag,
                         msgLength);
}

void EventProcessor::handleMPIRecv(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
  ...
  OTF2_EvtWriter_MpiRecv(m_evtWriter, attributeList, time, sender, communicator, msgTag,
                         msgLength);
}

void EventProcessor::handleMPIISend(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                    uint32_t receiver, OTF2_CommRef communicator,
  ...
  OTF2_EvtWriter_MpiIsend(m_evtWriter, attributeList, time, receiver, communicator, msgTag,
                          msgLength, requestID);
}

void EventProcessor::handleMPIIRecv(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
  ...
  OTF2_EvtWriter_MpiIrecv(m_evtWriter, attributeList, time, sender, communicator, msgTag,
                          msgLength, requestID);
}
...
void EventProcessor::handleMPIRequestCancelled(OTF2_AttributeList* attributeList,
                                               OTF2_TimeStamp time, uint64_t requestID) {

  time = m_maps.getNewTimestamp(time);

  OTF2_EvtWriter_MpiRequestCancelled(m_evtWriter, attributeList, time, requestID);
}
...
void EventProcessor::handleMPIEndProps(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                       OTF2_CollectiveOp collectiveOp,
                                       OTF2_CommRef communicator, uint32_t root,
                                       uint64_t sizeSent, uint64_t sizeReceived) {
  ...
  OTF2_EvtWriter_MpiCollectiveEnd(m_evtWriter, attributeList, time, collectiveOp, communicator,
                                  root, sizeSent, sizeReceived);
}

void EventProcessor::handleOmpFork(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                   uint32_t numberOfRequestedThreads) {

  time = m_maps.getNewTimestamp(time);

  OTF2_EvtWriter_OmpFork(m_evtWriter, attributeList, time, numberOfRequestedThreads);
}

void EventProcessor::handleOmpJoin(OTF2_AttributeList* attributeList, OTF2_TimeStamp time) {
...
void EventProcessor::handleOmpAcquireLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_OmpAcquireLock(m_evtWriter, attributeList, time, lockID, acquisitionOrder);
}
...
void EventProcessor::handleOmpReleaseLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_OmpReleaseLock(m_evtWriter, attributeList, time, lockID, acquisitionOrder);
}
...
void EventProcessor::handleThreadFork(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                      OTF2_Paradigm model, uint32_t numberOfRequestedThreads) {

  time = m_maps.getNewTimestamp(time);

  OTF2_EvtWriter_ThreadFork(m_evtWriter, attributeList, time, model, numberOfRequestedThreads);
}

void EventProcessor::handleThreadJoin(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                      OTF2_Paradigm model) {
...
void EventProcessor::handleThreadTeamBegin(OTF2_AttributeList* attributeList,
                                           OTF2_TimeStamp time, OTF2_CommRef threadTeam) {
...
void EventProcessor::handleThreadAcquireLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_ThreadAcquireLock(m_evtWriter, attributeList, time, model, lockID,
                                   acquisitionOrder);
}
...
void EventProcessor::handleThreadReleaseLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_ThreadReleaseLock(m_evtWriter, attributeList, time, model, lockID,
                                   acquisitionOrder);
}
...
void EventProcessor::handleThreadTaskCreate(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_ThreadTaskCreate(m_evtWriter, attributeList, time, threadTeam, creatingThread,
                                  generationNumber);
}
...
void EventProcessor::handleThreadTaskSwitch(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_ThreadTaskSwitch(m_evtWriter, attributeList, time, threadTeam, creatingThread,
                                  generationNumber);
}
...
void EventProcessor::handleThreadTaskComplete(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_ThreadTaskComplete(m_evtWriter, attributeList, time, threadTeam,
                                    creatingThread, generationNumber);
}

void EventProcessor::handleThreadCreate(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
  ...
  OTF2_EvtWriter_ThreadCreate(m_evtWriter, attributeList, time, threadContingent,
                              sequenceCount);
}

void EventProcessor::handleThreadBegin(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                       OTF2_CommRef threadContingent, uint64_t sequenceCount) {
...
void EventProcessor::handleThreadWait(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                      OTF2_CommRef threadContingent, uint64_t sequenceCount) {
  ...
  OTF2_EvtWriter_ThreadWait(m_evtWriter, attributeList, time, threadContingent, sequenceCount);
}

void EventProcessor::handleThreadEnd(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                     OTF2_CommRef threadContingent, uint64_t sequenceCount) {
  ...
  OTF2_EvtWriter_ThreadEnd(m_evtWriter, attributeList, time, threadContingent, sequenceCount);
}
...
void EventProcessor::handleIoCreateHandle(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoCreateHandle(m_evtWriter, attributeList, time, handle, mode, creationFlags,
                                statusFlags);
}
...
void EventProcessor::handleIoHandleDuplicate(OTF2_AttributeList* attributeList,
                                             OTF2_TimeStamp time, OTF2_IoHandleRef oldHandle,
                                             OTF2_IoHandleRef  newHandle,
                                             OTF2_IoStatusFlag statusFlags) {
  ...
  OTF2_EvtWriter_IoDuplicateHandle(m_evtWriter, attributeList, time, oldHandle, newHandle,
                                   statusFlags);
}

void EventProcessor::handleIoSeek(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
  ...
  OTF2_EvtWriter_IoSeek(m_evtWriter, attributeList, time, handle, offsetRequest, whence,
                        offsetResult);
}

void EventProcessor::handleIoChangeStatusFlags(OTF2_AttributeList* attributeList,
                                               OTF2_TimeStamp time, OTF2_IoHandleRef handle,
                                               OTF2_IoStatusFlag statusFlags) {
  ...
  OTF2_EvtWriter_IoChangeStatusFlags(m_evtWriter, attributeList, time, handle, statusFlags);
}

void EventProcessor::handleIoDeleteFile(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                        OTF2_IoParadigmRef ioParadigm, OTF2_IoFileRef file) {
  ...
  OTF2_EvtWriter_IoDeleteFile(m_evtWriter, attributeList, time, ioParadigm, file);
}
...
void EventProcessor::handleIoOperationBegin(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoOperationBegin(m_evtWriter, attributeList, time, handle, mode,
...
void EventProcessor::handleIoOperationTest(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoOperationTest(m_evtWriter, attributeList, time, handle, matchingId);
}
...
void EventProcessor::handleIoOperationIssued(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoOperationIssued(m_evtWriter, attributeList, time, handle, matchingId);
}

void EventProcessor::handleIoOperationComplete(OTF2_AttributeList* attributeList,
                                               OTF2_TimeStamp time, OTF2_IoHandleRef handle,
  ...
  OTF2_EvtWriter_IoOperationComplete(m_evtWriter, attributeList, time, handle, bytesResult,
                                     matchingId);
}

void EventProcessor::handleIoOperationCancelled(OTF2_AttributeList* attributeList,
                                                OTF2_TimeStamp time, OTF2_IoHandleRef handle,
                                                uint64_t matchingId) {
  ...
  OTF2_EvtWriter_IoOperationCancelled(m_evtWriter, attributeList, time, handle, matchingId);
}
...
void EventProcessor::handleIoAcquireLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoAcquireLock(m_evtWriter, attributeList, time, handle, lockType);
}
...
void EventProcessor::handleIoReleaseLock(OTF2_AttributeList* attributeList,
  ...
  OTF2_EvtWriter_IoReleaseLock(m_evtWriter, attributeList, time, handle, lockType);
}

void EventProcessor::handleIoTryLock(OTF2_AttributeList* attributeList, OTF2_TimeStamp time,
                                     OTF2_IoHandleRef handle, OTF2_LockType lockType) {
